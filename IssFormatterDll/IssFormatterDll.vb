...
Public Class IssFormatter
    ...
    Public Shared Function FormatIssToString(IssScript As String, IndentSpaces As Integer, IndentIf As Boolean, IndentTry As Boolean, IndentCase As Boolean, IndentOnlyBegin As Boolean, Optional CapitalType As Integer = 0,  Optional OutputFilePath As String = "") As String
    ...
    Private Shared Function CountExact(line As String, keyword As String) As Integer
    ...
    Private Shared Function ApplyCapitalization(line As String, mode As Integer) As String
    ...
    Public Shared Function FormatIssToStream(IssScript As String, IndentSpaces As Integer, IndentIf As Boolean, IndentTry As Boolean, IndentCase As Boolean, IndentOnlyBegin As Boolean) As MemoryStream
